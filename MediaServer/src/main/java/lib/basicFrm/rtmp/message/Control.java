...
public class Control extends AbstractMessage {
    ...
    private static final AnyLogger logger = AnyLogger.getInstance();
    ...
    public static Control streamControlStart()
    {
    	return new Control(0, Type.BUFFER_FULL);
    }
    
    public static Control streamControlEnd()
    {
    	return new Control(0, Type.BUFFER_EMPTY);
    }
    ...
    public String toString() {
        ...
        if(bytes != null) {
            sb.append(" bytes: " + StringUtils.toHex(bytes));
        }
        return sb.toString();
    }
